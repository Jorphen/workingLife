...
("undefined" != typeof window ? window : this, function (a, b)
{
            ...
            }, d.find.CLASS = c.getElementsByClassName && function (a, b)
            {
                return p ? b.getElementsByClassName(a) : void 0
            }, r = [], q = [], (c.qsa = $.test(g.querySelectorAll)) && (ja(function (a)
                    {
                        ...
                        a.querySelectorAll("[selected]").length || q.
                        push("\\[" + L + "*(?:value|" + K + ")"),
                        ...
                        if (g && a["throws"])
                            ...
                            catch (l)
                            {
                                return
                                {
                                    state : "parsererror",
                                    erro
                                    r : g ? l : "No conversion from " + i + " to " + f
                                }
                            }
                }
        return {
    ...
    m.ajaxPrefilter("script", function (a)
    {
        ...
        a.cr
        ossDomain && (a.type = "GET", a.global = !1)
    }
    ),
    ...
    }, function (a, b)
    {
        ...
        m.fn[a] = function (d)
        {
            return V(this, function (a, d, e)
            {
                var f = dc(a);
                return void 0 === e
                 ? f ? b in f ? f[b] : f.document.documentElement[d] : a[d] : void(f ? f.scrollTo(c ? m(f).scrollLeft() : e, c ? e : m(f).scrollTop()) : a[d] = e)
